...
// Large, touch-friendly, low-clutter type scale (per UI/UX requirements:
// clean, easy to read on low-end screens, Hindi + English friendly).
val KaamSetuTypography = Typography(
